...
{
    public partial class FrmVistaProveedorIngresos : Form
    {
        public FrmVistaProveedorIngresos()
        {
            InitializeComponent();
        }

        private void FrmVistaProveedorIngresos_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        }
        ...
        {
            this.dataListado.DataSource = NProveedores.BuscarRazon_social(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            this.dataListado.DataSource = NProveedores.BuscarNum_Documento(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }

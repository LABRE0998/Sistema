...
namespace CapaPresentaciones
{
    public partial class FrmVentas : Form
    {
        ...
        {
            FrmVistaClienteVentas vista = new FrmVistaClienteVentas();
            vista.ShowDialog();
        }
        ...
        {
            FrmVistaProductosVentas vista = new FrmVistaProductosVentas();
            vista.ShowDialog();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (this.IsNuevo)
                    {
                        rpta = NVentas.Insertar(Convert.ToInt32(this.txtIdcliente.Text), Idtrabajador,
        ...
        private void txtStock_Actual_TextChanged(object sender, EventArgs e)
        {

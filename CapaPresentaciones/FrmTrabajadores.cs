...
namespace CapaPresentaciones
{
    public partial class FrmTrabajadores : Form
    {
        ...
        {
            this.dataListado.DataSource = NTrabajadores.Mostrar();
            this.OcultarColumnas();
            lblTotal.Text = "Total Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        private void BuscarApellidos()
        {
            this.dataListado.DataSource = NTrabajadores.BuscarApellidos(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            this.dataListado.DataSource = NTrabajadores.BuscarNum_Documento(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataListado.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            Rpta = NTrabajadores.Eliminar(Convert.ToInt32(Codigo));
            ...
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        ...
                        Rpta = NTrabajadores.Insertar(this.txtNombre.Text.Trim().ToUpper(),
                    ...
                    else
                    {
                        ...
                        Rpta = NTrabajadores.Editar(Convert.ToInt32(this.txtIdtrabajador.Text), this.txtNombre.Text.Trim().ToUpper(),
                        this.txtApellidos.Text.Trim().ToUpper(), cbSexo.Text,
                        dtFecha_Nacimiento.Value,
                        txtNum_Documento.Text, txtDireccion.Text,
                        txtTelefono.Text, txtEmail.Text, cbAcceso.Text, txtUsuario.Text, txtPassword.Text);

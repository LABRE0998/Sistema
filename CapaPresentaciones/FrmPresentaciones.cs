...
namespace CapaPresentaciones
{
    public partial class FrmPresentaciones : Form
    {
        ...
        {
            this.dataListado.DataSource = NPresentaciones.Mostrar();
        ...
        {
            this.dataListado.DataSource = NPresentaciones.BuscarNombre(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NPresentaciones.Insertar(this.txtNombre.Text.Trim().ToUpper(),
                            this.txtDescripcion.Text.Trim());

                    }
                    else
                    {
                        rpta = NPresentaciones.Editar(Convert.ToInt32(this.txtIdpresentacion.Text),
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataListado.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            Rpta = NPresentaciones.Eliminar(Convert.ToInt32(Codigo));
        ...
        {
            Reportes.FrmReportePresentaciones frm = new Reportes.FrmReportePresentaciones();

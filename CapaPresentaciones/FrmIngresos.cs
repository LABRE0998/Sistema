...
namespace CapaPresentaciones
{
    public partial class FrmIngresos : Form
    {
        ...
        {
            FrmVistaProveedorIngresos vista = new FrmVistaProveedorIngresos();
            vista.ShowDialog();
        }

        private void btnBuscarArticulo_Click(object sender, EventArgs e)
        {
            FrmVistaProductosIngresos vista = new FrmVistaProductosIngresos();
            vista.ShowDialog();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (this.IsNuevo)
                    {
                        rpta = NIngresos.Insertar(Idtrabajador, Convert.ToInt32(this.txtIdproveedor.Text),
                            Convert.ToDateTime(dtFecha.Value), cbTipo_Comprobante.Text, txtSerie.Text, txtCorrelativo.Text,

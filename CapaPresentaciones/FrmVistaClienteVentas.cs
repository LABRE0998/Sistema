...
{
    public partial class FrmVistaClienteVentas : Form
    {
        public FrmVistaClienteVentas()
        {
            InitializeComponent();
        }

        private void FrmVistaClienteVentas_Load(object sender, EventArgs e)
        {
            Mostrar();
        }
        ...
        {
            this.dataListado.DataSource = NClientes.BuscarApellidos(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            this.dataListado.DataSource = NClientes.BuscarNum_Documento(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }

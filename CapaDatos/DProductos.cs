...
namespace CapaDatos
{
    public class DProductos
    {
        ...
        public DProductos(int idarticulo, string codigo, string nombre, string descripcion, byte[] imagen, int idcategoria, int presentacion, string textobuscar)
        {
        ...
        public string Insertar(DProductos Articulo)
        {
            string rpta = "";
        ...
        //Método Editar
        public string Editar(DProductos Articulo)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        //Método Eliminar
        public string Eliminar(DProductos Articulo)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        //Método BuscarNombre
        public DataTable BuscarNombre(DProductos Articulo)
        {
            DataTable DtResultado = new DataTable("articulo");
            SqlConnection SqlCon = new SqlConnection();
            try

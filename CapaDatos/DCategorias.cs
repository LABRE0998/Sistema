...
namespace CapaDatos
{
    public class DCategorias
    {
        ...
        public DCategorias(int idcategoria, string nombre, string descripcion, string textobuscar)
        {
        ...
        //Método Eliminar
        public string Eliminar(DCategorias Categoria)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        //Método BuscarNombre
        public DataTable BuscarNombre(DCategorias Categoria)
        {
            DataTable DtResultado = new DataTable("categoria");
            SqlConnection SqlCon = new SqlConnection();
            try

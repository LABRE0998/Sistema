...
namespace CapaDatos
{
    public class DPresentaciones
    {
        ...
        public DPresentaciones()
        {

        }

        public DPresentaciones(int idpresentacion, string nombre, string descripcion, string textobuscar)
        {
        ...
        //Insertar
        public string Insertar(DPresentaciones Presentacion)
        {
            string rpta = "";
        ...
        //Método Editar
        public string Editar(DPresentaciones Presentacion)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        //Método Eliminar
        public string Eliminar(DPresentaciones Presentacion)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        //Método BuscarNombre
        public DataTable BuscarNombre(DPresentaciones Presentacion)
        {
            DataTable DtResultado = new DataTable("presentacion");
            SqlConnection SqlCon = new SqlConnection();
            try

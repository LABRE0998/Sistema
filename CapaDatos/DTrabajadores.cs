...
namespace CapaDatos
{
    public class DTrabajadores
    {
        ...
        public DTrabajadores(int idtrabajador, string nombre, string apellidos, string sexo,
        ...
        //Métodos
        public string Insertar(DTrabajadores Trabajador)
        {
            string rpta = "";
        ...
        //Método Editar
        public string Editar(DTrabajadores Trabajador)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        //Método Eliminar
        public string Eliminar(DTrabajadores Trabajador)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public DataTable BuscarApellidos(DTrabajadores Trabajador)
        {
            DataTable DtResultado = new DataTable("trabajador");
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public DataTable BuscarNum_Documento(DTrabajadores Trabajador)
        {
            DataTable DtResultado = new DataTable("trabajador");
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public DataTable Login(DTrabajadores Trabajador)
        {
            DataTable DtResultado = new DataTable("trabajador");
            SqlConnection SqlCon = new SqlConnection();
            try

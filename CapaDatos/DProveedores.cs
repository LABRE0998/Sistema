...
namespace CapaDatos
{
    public class DProveedores
    {
        ...
        public DProveedores(int idproveedor, string razon_social, string sector_comercial, string tipo_documento, string num_documento, string direccion, string telefono, string email, string url, string textobuscar)
        {
        ...
        //Método BuscarNombre
        public DataTable BuscarRazon_Social(DProveedores Proveedor)
        {
            DataTable DtResultado = new DataTable("proveedor");
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public DataTable BuscarNum_Documento(DProveedores Proveedor)
        {
            DataTable DtResultado = new DataTable("proveedor");
            SqlConnection SqlCon = new SqlConnection();
            try

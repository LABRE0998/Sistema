   ...
   public  class DIngresos
    {
        ...
        public DIngresos(int idingreso, int idtrabajador, int idproveedor,
        ...
        //Métodos
        public string Insertar(DIngresos Ingreso, List<DDetalleIngresos> Detalle)
        {
            string rpta = "";
            ...
            try
            {
                ...
                if (rpta.Equals("OK"))
                {
                    ...
                    foreach (DDetalleIngresos det in Detalle)
                    {
        ...
        public string Anular(DIngresos Ingreso)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
